...
const run = async (lane, job) => {
  ...
  if (!provisioningProfile) {
    ...
    provisioningProfile = execSync(`xcodebuild -showBuildSettings -target ${target} -configuration ${buildConfiguration} | grep " PROVISIONING_PROFILE = "`).toString().replace('PROVISIONING_PROFILE = ', '').trim();
  }
